...
/**
 * Real inquiry #11400001 亞洲婦女協進會.
 * 0900–1300, 2 Chief photographer + 2 video assistants, 400 photos,
 * 2–3min highlight + 30s IG + 25s same-day clip.
 */
export const AWL_FIXTURE = `本機構現正為本會9月12日拍攝活動花絮，誠邀貴公司就以下項目提供全包書面報價：
拍攝日期：9月12日
拍攝時間：0900 – 1300
拍攝地址：九龍塘禧福道3號何梁潔庭大樓地下禮堂
拍攝安排：2 Chief photographer + 2 拍攝助理 (video)
-即日出部份相片作出 media
-所有調色高像素相片 （不少於400 張, 活動一星期內）
-1條2-3分鐘活動highlight
-1 條30秒IG Story
-即日攝錄剪輯活動花絮（25秒）
-所有攝錄的活動素材
